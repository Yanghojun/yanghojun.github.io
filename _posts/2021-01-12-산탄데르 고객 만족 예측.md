...
3. var3 Feature를 볼 때 -999999 값은 다른 값들에 비해 너무 큼. Nan, 특정 예외값을 -999999로 처리한것으로 보임. 가장 많이 보이는 2로 대체
...
4. 브로드캐스팅을 활용하여 split한 데이터들의 레이블별 %를 쉽게 나타냄
